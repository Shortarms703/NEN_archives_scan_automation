...
imgs = [os.path.join(directory, x) for x in sorted(os.listdir(directory))[1:] if x.lower().endswith('.jpg')]
img_list = []
all_bounds = []
for filein in imgs:
...
canv = canvas.Canvas('/Users/joshua/PycharmProjects/NEN_archives/new_and_improved/renders/1980_06 June_cropped.pdf')
